...
void Camera::rotate_camera_roll(double angle) {
	...
	camera_rotation_inv = (rotationRoll(-angle) * camera_rotation_inv);
}
...
void Camera::rotate_camera_pitch(double angle) {
	...
	camera_rotation_inv = (rotationPitch(-angle) * camera_rotation_inv);
}
...
void Camera::rotate_camera_yaw(double angle) {
	...
	camera_rotation_inv = (rotationYaw(-angle) * camera_rotation_inv);
}
